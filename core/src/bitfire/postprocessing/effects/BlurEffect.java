...
import bitfire.postprocessing.filters.Switcher;
...
public final class BlurEffect extends PostProcessorEffect {
	...
	public BlurEffect (int fboWidth, int fboHeight) {
	...
	public void setBaseIntesity (float intensity) {
		switcher.setSource1Intensity(intensity);
	}

	public void setBaseSaturation (float saturation) {
		switcher.setSource1Saturation(saturation);
	}

	public void setBloomIntesity (float intensity) {
		switcher.setSource2Intensity(intensity);
	}

	public void setBloomSaturation (float saturation) {
		switcher.setSource2Saturation(saturation);
	}
	...
	public void setSwitcher(float switcher) {
		this.switcher.setSwitch(switcher);
	}
	...
	public float getBaseIntensity () {
		return switcher.getSource1Intensity();
	}

	public float getBaseSaturation () {
		return switcher.getSource1Saturation();
	}

	public float getBloomIntensity () {
		return switcher.getSource2Intensity();
	}

	public float getBloomSaturation () {
		return switcher.getSource2Saturation();
	}
	...
	public void render (final FrameBuffer src, final FrameBuffer dest) {
		...
		switcher.setOutput(dest).setInput(texsrc, pingPongBuffer.getResultTexture()).render();
	}
